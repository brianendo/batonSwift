...
//    func createLabel() {
//        progressLabel = UILabel(frame: CGRectMake(0.0, 0.0, CGRectGetWidth(frame), 60))
...
//        let centerPoint = CGPointMake(CGRectGetWidth(frame)/2 , CGRectGetHeight(frame)/2)
        ...
        path.moveToPoint(CGPointMake(0, CGRectGetHeight(frame)/2))
        path.addLineToPoint(CGPointMake(CGRectGetWidth(frame), CGRectGetHeight(frame)/2))
